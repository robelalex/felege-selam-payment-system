...
export const teacherLogin = (email, password) => teacherApi.post('/login/', { email, password });
export const verifyTeacherOtp = (userId, otpCode) => teacherApi.post('/verify/', { user_id: userId, otp_code: otpCode });
