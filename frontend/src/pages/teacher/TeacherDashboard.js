...
function TeacherDashboard() {
  ...
  // ✅ RESTORED: popup subject picker for "Review Marks" (this is the
  // flow the school wants — pick a subject, then see the full students
  // table with the term dropdown, same table the subject teacher uses).
